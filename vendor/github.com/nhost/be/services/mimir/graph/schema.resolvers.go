...
func (r *queryResolver) RunServiceConfigs(ctx context.Context, resolve bool, where *model.ConfigRunServiceConfigComparisonExp) ([]*model.ConfigRunServiceConfigWithID, error) {
	return r.runServiceConfigs(ctx, resolve, where)
}
